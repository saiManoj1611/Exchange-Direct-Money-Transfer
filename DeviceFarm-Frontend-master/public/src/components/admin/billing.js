    ...
    render() {
        ...
        return (
            <div className="container" style={{ backgroundColor: "white", marginTop: "10px", overflowX: "hidden", overflowY: "hidden", boxShadow: "0 2px 5px rgba(0,0,0,0.3)" }}>
                ...
                {graph}
                <div style={{textAlign:"-webkit-center", paddingBottom:'20px'}}>
                <Link to="/admin/viewbills" style={{ color: "white", fontSize:'1.5rem', textDecoration: 'none' }}><Button variant="contained" style={{fontSize:'1.5rem'}} color="primary">View Bills</Button></Link>
                </div>
            </div>
        )
    }

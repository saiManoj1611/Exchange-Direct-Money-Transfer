...
function OnDemandDeviceType(props) {
    ...
    return (
        ...
        <div className="row">
            <Link to={{ pathname: `/tester/${sessionStorage.getItem("id")}/project/${projectId}/ondemand_allocations/real`}} style={{ textDecoration: "none" }}>
            ...
            <Link to={{ pathname: `/tester/${sessionStorage.getItem("id")}/project/${projectId}/ondemand_allocations/emulator`}} style={{ textDecoration: "none" }}>
...
export default OnDemandDeviceType;
                        ...
                        <div class="main-div">
                            ...
                            <div className="row" style={{ marginLeft: "35px", marginBottom: "7px" }}>
                                <div class="col-md-5 radio-inline">
                                    <input type="radio" value="tester" name="persona" defaultChecked onChange={this.changePersona} /><p>I'm a Tester</p>
                                </div>
                                <div class="col-md-5 radio-inline">
                                    <input type="radio" value="manager" name="persona" onChange={this.changePersona} /><p>I'm a Manager</p>
                                </div>
                            </div>
